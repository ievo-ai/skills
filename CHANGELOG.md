...
## [0.8.0](https://github.com/ievo-ai/skills/compare/v0.7.0...v0.8.0) (2026-05-26)


### Features

* add /ievo:vuln-scan — Glasswing-inspired source code vulnerability scanner ([ff52dbb](https://github.com/ievo-ai/skills/commit/ff52dbb2bc4c34c130b9a6a328d09de716e47340))
* add /ievo:vuln-scan — Glasswing-inspired source code vulnerability scanner ([df840da](https://github.com/ievo-ai/skills/commit/df840da9e84619080da71510b04aa64773335f5a)), closes [#71](https://github.com/ievo-ai/skills/issues/71)
* add review-fixer.yml — auto-fix claude-review findings on handler PRs ([be801d4](https://github.com/ievo-ai/skills/commit/be801d43cadeaa1ed47d0bd7f09584f91dcc5761)), closes [#96](https://github.com/ievo-ai/skills/issues/96)
* issue-handler opens draft PR at start of implementation ([a3e0ea1](https://github.com/ievo-ai/skills/commit/a3e0ea1be7f078d6e357e0b54b76d21cbb7e34e0))
* issue-handler opens draft PR at start of implementation ([8ff159a](https://github.com/ievo-ai/skills/commit/8ff159a15e511abbcaf0d875872480ee889490e4)), closes [#92](https://github.com/ievo-ai/skills/issues/92)
* replace release-please with auto-bump workflow ([de97d09](https://github.com/ievo-ai/skills/commit/de97d095e3159f26d82929098374879cfc54b5c1))
* replace release-please with auto-bump workflow ([7f6ffe3](https://github.com/ievo-ai/skills/commit/7f6ffe3c19d34b730bc2926bccfedc9c4673a6e0)), closes [#120](https://github.com/ievo-ai/skills/issues/120)
* unified pr-fixer — auto-fix ANY failed check on handler PRs ([de8fbbd](https://github.com/ievo-ai/skills/commit/de8fbbd010d9330657d02fc9c33f10ae09797b27))
* unified pr-fixer — auto-fix ANY failed check on handler PRs ([c6b54e7](https://github.com/ievo-ai/skills/commit/c6b54e7df818ae61bdbd9c429c5e102339818c00)), closes [#97](https://github.com/ievo-ai/skills/issues/97)


### Bug Fixes

* add --base main, drop redundant --head, remove dead null guard ([1f50499](https://github.com/ievo-ai/skills/commit/1f5049946c56da63e07f9f00deb80af762aef4de))
* add adversarial-content guard to vuln-scan (round-6 F1) ([6e4d21c](https://github.com/ievo-ai/skills/commit/6e4d21cea96ada77f5d37e375851bbf9c05a53e3))
* add commands/vuln-scan.md to minimum file set ([5f3e994](https://github.com/ievo-ai/skills/commit/5f3e99429c4d8a47e095ee3377022945ca4c7101))
* add cross-check validation before commit in step 4d retrigger path ([039e9dc](https://github.com/ievo-ai/skills/commit/039e9dce8198cc68ec1845f853027fa484edea89))
* add error handling for gh pr ready promotion ([5f92d3c](https://github.com/ievo-ai/skills/commit/5f92d3c3c21242a68267a3e3bee41ee61db51ce5))
* add missing effort: frontmatter to schedule skill ([194963b](https://github.com/ievo-ai/skills/commit/194963bc25df7b16283b9cbf563c923b5fe24c35))
* add missing effort: frontmatter to schedule skill ([841240a](https://github.com/ievo-ai/skills/commit/841240af7aa343dcdba9d4d32384f9bce1f53ddf))
* add no-changes guard to pr-fixer.md Step 4 ([1b124e8](https://github.com/ievo-ai/skills/commit/1b124e852d9ff6c26eceedb3fd2bea925f5f528f))
* add pre-loop budget check to prevent off-by-one on restart ([eaaa12a](https://github.com/ievo-ai/skills/commit/eaaa12ad524787ce1a3e22ad0b221f340b7b7910))
* add reopened trigger to issue-handler workflow ([4935589](https://github.com/ievo-ai/skills/commit/493558936ee2a43dfe130bc3d329dcdf1a944905))
* add reopened trigger to issue-handler workflow ([42b969f](https://github.com/ievo-ai/skills/commit/42b969f4f8147f600a36231cf5be2d3fd458bcc4))
* address claude-review findings on vuln-scan ([22a101d](https://github.com/ievo-ai/skills/commit/22a101df8fb930efc57f3474ce0f733eff639040))
* address review feedback (round 1) [pr-fix-1] ([71ae150](https://github.com/ievo-ai/skills/commit/71ae150f38559b280ae97317a1be6e00c6a5c7cd))
* address review feedback (round 2) [pr-fix-2] ([a8b646e](https://github.com/ievo-ai/skills/commit/a8b646ed19f1f01fc147dfed907d877e2873208b))
* address review feedback (round 3) [pr-fix-3] ([c927197](https://github.com/ievo-ai/skills/commit/c9271979b8f9530ab1ef498324f4d5bd7140ce4d))
* address review feedback (round 4) [pr-fix-4] ([910161b](https://github.com/ievo-ai/skills/commit/910161b60990c5273f85efcddc3068c6b59202c8))
* address review feedback (round 5) [pr-fix-5] ([63a263f](https://github.com/ievo-ai/skills/commit/63a263f3d0214379f6a49931373681afb8c4629e))
* address round-2 review findings on draft PR feature ([00bb95d](https://github.com/ievo-ai/skills/commit/00bb95dd7d8664232de61f12dfc16afb6e591fab))
* address round-2 review findings on vuln-scan (F1-F8) ([0ca2c47](https://github.com/ievo-ai/skills/commit/0ca2c4750157ae5512d8e415e95df1c757184630))
* address round-3 review findings on draft PR feature ([9207d7f](https://github.com/ievo-ai/skills/commit/9207d7f1c3f1d7fc6e649617a9c94b40a9d06477))
* address round-3 review findings on vuln-scan (F1,F3,F5,F6,F8) ([0b55bb0](https://github.com/ievo-ai/skills/commit/0b55bb077ea31a3a0333eccc498bb88a48bc3b8a))
* address round-4 review findings on vuln-scan (F1-F3) ([665d5d2](https://github.com/ievo-ai/skills/commit/665d5d24f55a4655c28f80bd6b985acc95098d7f))
* address round-5 review findings on PR [#107](https://github.com/ievo-ai/skills/issues/107) ([80449aa](https://github.com/ievo-ai/skills/commit/80449aa884d95fb3f6cd49f59bafbee2f9df277a))
* address round-5 review findings on vuln-scan (F1-F3) ([1e9fef7](https://github.com/ievo-ai/skills/commit/1e9fef765c9568735247dbcebaa2b20544e70d5e))
* address round-7 review findings (F1-F3) ([3f67ad1](https://github.com/ievo-ai/skills/commit/3f67ad1db0d96f08d630f6715bed40b733588fd2))
* allow rotnov-authored issues to request workflow changes ([e73b4b7](https://github.com/ievo-ai/skills/commit/e73b4b7f6dfd11b4e10c1441071ac60e16b4514c))
* detect review findings after PASS status in handler Phase 5 ([140da03](https://github.com/ievo-ai/skills/commit/140da0333c56bdc392d6f8523304c4d17947a9dd))
* detect review findings after PASS status in handler Phase 5 ([2b09f4d](https://github.com/ievo-ai/skills/commit/2b09f4d55212888e123724b855d861462dc58f1a)), closes [#116](https://github.com/ievo-ai/skills/issues/116)
* document CHANGELOG format + branch protection bypass requirement ([0e1ecb9](https://github.com/ievo-ai/skills/commit/0e1ecb9fe4c59a2fe50203f019d340a8f68604eb))
* gate issue-handler on org membership instead of hardcoded usernames ([763dcd4](https://github.com/ievo-ai/skills/commit/763dcd44e836027d65c676c10111a81218e42a45))
* guard Phase 6 against posting success after budget exhaustion ([649ac21](https://github.com/ievo-ai/skills/commit/649ac21f835f31c11c1fdc4d1c5e91f475fe08ac))
* guard review-fixer against missing prompt file ([961481e](https://github.com/ievo-ai/skills/commit/961481e0ed74fdf7a916af60e97671144c7ec48a))
* guard review-fixer against missing prompt file on older branches ([e08cbf8](https://github.com/ievo-ai/skills/commit/e08cbf8943cfe4591f07a4b76305fc58bd67a402))
* invert finding detection — match known finding markers, not absence of clean phrases ([5cb9703](https://github.com/ievo-ai/skills/commit/5cb970377fe44b8fdb5cd40f154377b8df320241))
* make gh pr ready idempotent on handler retry ([1f9f676](https://github.com/ievo-ai/skills/commit/1f9f676385f697954cef16ccb445581c347f1aae))
* org member gate + author-only comment filter for issue-handler ([32f24ca](https://github.com/ievo-ai/skills/commit/32f24ca991b256c79773e079dafc4c8998964e51))
* org membership check now sees private members ([8151963](https://github.com/ievo-ai/skills/commit/81519632e7b248059823a501b72aa329cc94e42f))
* org membership check now sees private members ([60a09b5](https://github.com/ievo-ai/skills/commit/60a09b54d471b707afc116d36e595d4d995679b4))
* override REVIEW_STATE to FINDINGS so step 4a fix path runs ([cd720d4](https://github.com/ievo-ai/skills/commit/cd720d4814d00a508bf4719a32d8e7b7d27fd360))
* pagination + case-insensitive + tighter finding regex ([235e876](https://github.com/ievo-ai/skills/commit/235e876cc0f372c866a2bb7ad83f899af89cc84b))
* priority controls ordering not exclusion in vuln-scan dispatch ([1f1fa57](https://github.com/ievo-ai/skills/commit/1f1fa5782dcc44cf75b2fc77aa3e0009fdc907f1))
* quote debug-off description for YAML consistency ([75251f1](https://github.com/ievo-ai/skills/commit/75251f1bd4a8dea0e9a7ad95159f35abf06eb28c))
* quote YAML frontmatter in 5 SKILL.md files (Codex compatibility) ([08dae44](https://github.com/ievo-ai/skills/commit/08dae443d6d0043fa76270332e6fba43fb9ed3b4))
* quote YAML frontmatter values containing colons in 5 SKILL.md files ([ccbe007](https://github.com/ievo-ai/skills/commit/ccbe007f3c5a5d229d137844cfb239f077d513b0))
* remove NO_RUN_ATTEMPT reset in loop + fix Co-Authored-By whitespace ([bc8b2f0](https://github.com/ievo-ai/skills/commit/bc8b2f069e3cf91b4d693c89736c077cbe24c063))
* remove Russian trigger words from skill descriptions ([1bd7768](https://github.com/ievo-ai/skills/commit/1bd77683d991650ecfa7d40187f847988cde8cd0))
* reset NO_RUN_ATTEMPT per iteration + fix trailer whitespace ([6a99e7e](https://github.com/ievo-ai/skills/commit/6a99e7eb76e112ec92201db94e2c6dcc7d1560ce))
* restore prompt injection guard + fix scaffold commit comment ([9d7a0f9](https://github.com/ievo-ai/skills/commit/9d7a0f9bcaa46433ad9b11515f5ece2b37a760df))
* revert author_association gate — breaks on all events ([21da141](https://github.com/ievo-ai/skills/commit/21da1411df636dcc603c29f451a6d59768a96863))
* revert author_association gate — not available in webhook payload ([c35bdbc](https://github.com/ievo-ai/skills/commit/c35bdbc4b260f322064240b6ce03adb0e883b989))
* simplify author_association check syntax ([7ec17fe](https://github.com/ievo-ai/skills/commit/7ec17fec6323c52186c2259b8ec7613ac994a3a8))
* simplify author_association check with contains+fromJSON ([16531f8](https://github.com/ievo-ai/skills/commit/16531f877cbd003ebf575902bfe93b3eec1ebd9d))
* sync coverage-audit with v0.7.0 additions ([161cc8d](https://github.com/ievo-ai/skills/commit/161cc8dc1138ed50b83d11df77d7f52c423066b3))
* sync coverage-audit.md with v0.7.0 additions (vuln-scan + release-please) ([6b4b587](https://github.com/ievo-ai/skills/commit/6b4b58727bdbcbdf22ff560fb819cb2e83361ea3))
* update coverage-audit minimum file set ([066548b](https://github.com/ievo-ai/skills/commit/066548bf54bd5d0a9c36bfd9e6ad119aabb7d09e))
* use author_association for org gate instead of API calls ([eb06956](https://github.com/ievo-ai/skills/commit/eb069569c312d9caad0d6aa020ec956aaec92418))
* use author_association for org gate instead of API calls ([d871b11](https://github.com/ievo-ai/skills/commit/d871b119c2fb2dbe34b014ebf4746a088f067569))
* use repo collaborator check instead of org members endpoint ([835bf7a](https://github.com/ievo-ai/skills/commit/835bf7a938fc6e630e8a572f5e116bc61402fa25))
* use repo collaborator check instead of org members endpoint ([a2edfa6](https://github.com/ievo-ai/skills/commit/a2edfa61b5fcfa97715b935a6248c54f369ff34e))
* use Skill tool for vuln-scan invocation, not hardcoded Read path ([7a9b40c](https://github.com/ievo-ai/skills/commit/7a9b40c92d291dc4dbb9ed0e0c3cd3e192904545))
