...
3. **Command fails or returns empty output:** treat plugin state as unavailable — do not retry, do not block the handoff.
...
> <Only if Step 2f's platform was undetectable (neither Codex nor Claude Code):> Plugin state unavailable on this platform — verify iEvo (and any other referenced plugin) is installed in the receiving session before running suggested skills.
...
Platform: <Codex vN.N.N / Claude Code vN.N.N>
Installed plugins:
  - <name> vN.N.N (source: <marketplace>)
  - ...
