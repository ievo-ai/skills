...
- `sensitive_files` — output from Phase 0.5 classification (paths matched to sensitive patterns like `.env*`, `*.pem`, `*.key`, credentials files; may be empty)
